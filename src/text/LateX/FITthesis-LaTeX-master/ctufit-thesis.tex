...
citlivé na správné nastavení parametrů vzhledem k prostředí. Jedním z klíčových parametrů je pravděpodobnost detekce,
  ...
  který patří mezi základní algoritmy pro sledování více cílů, založeném na statistice konečných náhodných množin. Vhodnost
  použitého řešení je poté diskutována spolu s limitacemi a potenciálními budoucími možnostmi dalšího vylepšení.}
...
probability, which is often set as a constatnt. In this work, a method to estimate this probability for each target at
