...
probability, which is often constatnt. In this work, a method to estimate this probability for each target at
any time step is demonstrated through tracking objects on video footages. Advanced deep-learning algorithms for image
...
density (GM-PHD) filter is used. This filter falls among fundamental random finite sets statistics-based multi-target
