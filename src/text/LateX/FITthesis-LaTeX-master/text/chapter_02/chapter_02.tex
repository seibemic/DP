...
. The example of data association, which we talked about in Section \ref{sec:data_association}, is the PDA filter (Section \ref{sec:pda_filter}) or the integrated probabilistic data association filter. The updated version of these
...
Equations \eqref{eq:phd_linear_model_state}, \eqref{eq:phd_ps}, and \eqref{eq:phd_birth_intensity} - \eqref{eq
