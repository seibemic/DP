...
\begin{align}
    Z_k &= \left[ \bigcup_{x \in X_k} \Theta_k(x) \right] \cup \mathcal{K}_k.
\end{align}
...
estimation of multitarget states in the presence of clutter and data association uncertainties \cite{FISST}.
